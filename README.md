# Overview
**Nasmo** is a high-performance 3D game engine written in C++ with OpenGL. It offers a cross-platform API for writing 3D interactive applications and games complete with graphical and audio capabilities.

# Features
* **Clean, easy-to-use API**: Modular, object-oriented design allows for simple usage of the engine components.
* **Performant**: Optimized rendering techniques such as instancing results in high performance even on low-end devices.
* **Graphics**: High-fidelity graphics and lighting is available with a deferred physically-based renderer.
...
```
git clone https://github.com/Luminyx1/Nasmo.git
cd Nasmo
```
...
# License
All code in the `Nasmo` repository has been made available under the [MIT License](https://github.com/Luminyx1/Nasmo/blob/main/LICENSE.txt).
